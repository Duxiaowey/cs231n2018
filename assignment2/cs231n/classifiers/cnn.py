...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        daffine_x, dw3, db3 = affine_backward(dscores, affine_cache)
        daffine_relu_x, dw2, db2 = affine_relu_backward(daffine_x, affine_relu_cache)
        dconv_x, dw1, db1 = conv_relu_pool_backward(daffine_relu_x, conv_cache)
