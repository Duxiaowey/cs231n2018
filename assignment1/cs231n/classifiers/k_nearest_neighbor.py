...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        Returns:
        - dists: A numpy array of shape (num_test, num_train) where dists[i, j] is the Euclidean distance between the ith test point and the jth training
          point.
        """
        num_test = X.shape[0]
        print(X.shape[0])
    ...
    def compute_distances_no_loops(self, X):
        ...
        #########################################################################
        X_2 = np.array([np.sum(X ** 2, axis=1)] * num_train).T
        X_train_2 = np.array([np.sum(self.X_train ** 2, axis=1)] * num_test)
        dists = X_2 + X_train_2 - 2 * X.dot(self.X_train.T)
        #########################################################################
        #                         END OF YOUR CODE                              #
        #########################################################################
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            #########################################################################
            # TODO:                                                                 #
            # Now that you have found the lab
            # els of the k nearest neighbors, you    #
